                ...
                <form action="changePassword" method="POST">
                    <table align="center" width="670">
                        ...
                        <tr height="50">
                            ...
                            <td width="155">Tên</td>
                            <td width="500"><input  class="userinfo" type="text" value="<%=session.getAttribute("sessuser")%>" style="width: 500px;"> </td>
                        </tr>

                        <tr height="50">

                            <td width="155">Số điện thoại</td>
                            <td width="500"><input class="userinfo"  type="text" value="<%=session.getAttribute("sessUserPhone")%>"  style="width: 500px;"></td>
                        </tr>

                        <tr height="50">

                            <td width="155">Email</td>
                            <td width="500"><input  class="userinfo" type="text" value="<%=session.getAttribute("sessUserEmail")%>" name="email" style="width: 500px;"></td>
                        </tr>

                        <tr height="50">

                            <td width="155">Địa chỉ</td>
                            <td width="500"><input  class="userinfo" type="text" value="<%=session.getAttribute("sessUserAdd")%>" style="width: 500px;"></td>
                        </tr>

                        <tr height="50" >
                            <td width="155">Mật khẩu cũ</td>
                            <td width="500"><input  class="userinfo" type="password" placeholder="Vui lòng nhập mật khẩu cũ" style="width: 500px;" name="oldPassword"></td>
                        </tr>

                        <tr height="50">
                            <td width="155">Mật khẩu mới</td>
                            <td width="500"><input class="userinfo"  class="userinfo"  type="password" placeholder="Vui lòng nhập mật khẩu mới" style="width: 500px;" name="newPassword"></td>
                        </tr>

                        <tr height="50">

                            <td width="155">Xác nhận mật khẩu</td>
                            <td width="500"><input  class="userinfo" type="password" placeholder="Vui lòng xác nhận mật khẩu" style="width: 500px;" name="confirmNewPassword"></td>
                        </tr>

                        <tr height="50"><td><input class="userinfo" type="submit" value="Thay đổi" name="update"></td><td></td></tr>
