            ...
            <div>
                ...
                <% CommentDAO cd = new CommentDAO();
                    ...
                    for (int i = 0; i < bList.size(); i++) {
                        ...
                        out.print("<div class=\"commentName\">");
                        int cID = bList.get(i).getcID();
                        out.print(cusdao.getcName(cID));
                        out.print("</div>");
                        out.print("<p class=\"commentContent\">");
                ...
                <form action ="AddComment" method="post">
                    <%
                        if (session.getAttribute("sessuser") != null) {
                            ...
                            out.print("<input type=\"text\" name=\"Comment\" style=\"width:535px;padding: 10px 0 70px 0;text-indent: 6px;margin : 20px 0;\" placeholder=\"Write your comment\">");
